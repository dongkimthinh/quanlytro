...
@section('content')
    <div class="container-fluid">
        ...
        <!-- Page Heading -->
        <h1 class="h3 mb-2 text-gray-800">Thông Tin Khách Đã Đăng Ký Tài Khoản</h1>
        {{-- <p class="mb-4">DataTables is a third party plugin that is used to generate the demo table below.
            For more information about DataTables, please visit the <a target="_blank"
                ...
                <ol class="breadcrumb">
                    ...
                    <li class="breadcrumb-item active" aria-current="page">Danh Sách Thông Tin</li>
                  </ol>
                </div>
                  <!-- DataTales Example -->
                        ...
                        <tbody>
                            ...
                            @foreach ($lienhe as $lh)
                                <tr>
                                    ...
                                    <td class="text-center" style="vertical-align: middle;">{{ $lh-> sdt }}</td>
                                    <td class="text-center" style="vertical-align: middle">
                                        <form action="{{ route('khachhangdelete',$lh->id) }}" method="GET">
                                            @csrf
                                        <a href="" class="btn btn-warning btn-sm" data-toggle="modal" data-target="#exampleModalCenter{{ $lh -> id }}"><i class="fas fa-edit"></i></a>
        ...
        <div class="modal fade" id="exampleModalCenter" tabindex="-1" role="dialog"
            ...
            <div class="modal-dialog modal-dialog-centered" role="document">
                <div class="modal-content">
                    ...
                    <form class="needs-validation" action="{{ route('addlienhe') }}" method="POST" enctype="multipart/form-data">
                        @csrf
                        <div class="modal-body">
                            ...
                            <div class="row">
                                ...
                                <div class="col-lg-12">
                                    <div class="form-group">
                                        <label>Email</label>
                                        <input class="form-control" name="email" id="validationCustom02" type="email" required>
                                ...
                                <div class="col-lg-12">
                                    <div class="form-group">
                                        ...
                                        <input class="form-control" name="sdt" id="validationCustom03" type="number" required>
                                    </div>
                                </div>
                            </div>
                        </div>
                    ...
                    <div class="row">
                        <div class="col-lg-12">
                            <div class="form-group">
                                ...
                                <input name="idkh" value="{{ $lh -> id }}" style="display: none">
                                <input class="form-control" name="tenkh" type="text" required value="{{ $lh -> ten }}">
                            </div>
                        </div>
                        <div class="col-lg-12">
                            <div class="form-group">
                                <label>Email</label>
                                <input class="form-control" name="email" type="email" required value="{{ $lh -> email }}">
                            </div>
                        </div>
                        <div class="col-lg-12">
                            <div class="form-group">
                                <label>Số Điện Thoại</label>
                                <input class="form-control" name="sdt" type="number" required value="{{ $lh -> sdt }}">
                            </div>
                        </div>
                    </div>
                    <div class="modal-footer">
